            ...
            return [
              ...
              ...syms.map(function (r) {
                ...
                return h('tr', { key: r.symbol + '|' + (r.sweep_timestamp || ''), className: 'tla-kelly-row' },
                  ...
                  h('td', { style: { color: isBuy ? 'var(--ui-accent,#4c9aff)' : isSell ? '#ff5c5c' : 'var(--ui-text-tertiary,#888)' } },
                    kellyVal.toFixed(3)),
                  ...
                  h('td', { style: { color: '#ff5c5c' } }, Number(r.stop_loss) > 0 ? fmtBrickPrice(r.stop_loss) : '—'),
      ...
      h('div', { className: 'tla-card' },
        ...
        h('div', { className: 'tla-field' },
          ...
          h('input', {
            ...
            readOnly: true,
            style: { background: 'rgba(127,127,127,0.1)', cursor: 'not-allowed' },
          }),
  ...
  function TalariaPage(props) {
    ...
    if (sweepRow) {
      ...
      if (sweepRow.stop_loss != null && Number(sweepRow.stop_loss) > 0)
        levels.push({ label: 'SL', price: Number(sweepRow.stop_loss), color: '#ff5c5c' });
            ...
            h('td', null,
              h('span', { className: 'tla-badge',
                style: {
                  ...
                  color: r.status === 'OVERCONFIDENT' ? '#ff5c5c' : r.status === 'UNDERCONFIDENT' ? '#78dc78' : 'var(--ui-text-tertiary,#888)',
                } },
                r.status || '—')
            )
          );
